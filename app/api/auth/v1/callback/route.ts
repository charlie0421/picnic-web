...
export async function POST(request: NextRequest): Promise<Response> {
    try {
        console.log(`Apple OAuth Callback Request (POST) at /api/auth/v1/callback:`, {
            url: request.url,
        ...
        console.log("Apple OAuth Callback Data at /api/auth/v1/callback:", {
            hasCode: !!code,
            hasState: !!state,
            ...
            process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!,
            {
                ...
                global: {
                    headers: {
                        ...
                        'X-Custom-Redirect-Url': 'https://api.picnic.fan/auth/v1/callback'
                    }
                }
            },
        );
        ...
        if (error || !data.session) {
            console.error("OAuth session exchange error at /api/auth/v1/callback:", {
                error,
