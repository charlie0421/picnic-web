        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='mb-8'>
            <div className='flex items-center gap-4 mb-4'>
              ...
              <div className='h-14 w-24 bg-gradient-to-r from-purple-200 to-pink-200 rounded' />
            ...
            <div className='px-6 py-8 sm:px-8 sm:py-10'>
              ...
              <div className='flex items-center justify-center gap-5 sm:gap-8'>
                <div className='flex flex-col items-center'>
                  ...
                  <div className='mt-2 h-4 w-16 bg-white/30 rounded' />
                </div>
                <div className='w-10 h-10 rounded-full bg-white/30' />
                <div className='flex flex-col items-center'>
                  <div className='w-24 h-24 rounded-full bg-white/30' />
                  <div className='mt-2 h-4 w-12 bg-white/30 rounded' />
                </div>
              </div>
              {/* 점수 영역 */}
              <div className='mt-6 flex items-center justify-between'>
                ...
                <div className='text-right space-y-1'>
                  <div className='h-10 w-20 bg-white/30 rounded ml-auto' />
