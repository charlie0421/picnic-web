        ...
        <ul className='mt-5 space-y-3'>
          {posts.map((post) => (
            <li key={post.id}>
              ...
              >
                <div className='absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-primary-200 via-sub-200 to-point-200 opacity-0 transition group-hover:opacity-100' />
