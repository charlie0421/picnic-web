...
import { VoteDetailPresenterProps } from './vote-detail-types';
...
export function VoteDetailPresenter(props: VoteDetailPresenterProps) {
  const {
    currentLanguage, voteItems, notifications, removeNotification,
    pollingStartTime, lastPollingUpdate, pollingErrorCount,
